...
-   tail: Should p-values be *upper.tail* (the observed value is larger
    than the expected values) r *left.tail* (the observed value is
...
This already gives us an important into the structure of facial
...
(62% of all angry faces), with is 45 times more than we would have
...
then each new case that I observed adds information about the condition.
